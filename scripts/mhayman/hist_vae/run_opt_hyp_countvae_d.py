...
settings = {
            'data_file': 'training_1_25particles_gamma.nc', #'histogram_training_data_5000count20200818T100751.nc',# 'histogram_training_data_5000count20200814T075733.nc',     # training data file
            'validation_file':'validation_1_25particles_gamma.nc',
            'test_file':'test_1_25particles_gamma.nc',
            ...
            'loss_function':'mse',     # loss function 'cum_poisson', 'kstest'
...
exec_file = 'optimize_countvae_d_hyperparam.py'
