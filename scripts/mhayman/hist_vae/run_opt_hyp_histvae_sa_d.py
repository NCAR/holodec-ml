...
settings = {
            ...
            'loss_function':'cum_mse',     # loss function 'cum_poisson', 'kstest'
            ...
            'num_dense_layers':[0,10,1],
            'num_input_nodes':[1,4096,64],
            'num_dense_nodes':[1,4096,32],
...
exec_file = 'optimize_histvae_atten_d_hyperparam.py'
