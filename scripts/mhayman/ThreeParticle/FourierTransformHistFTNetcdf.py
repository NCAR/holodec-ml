"""
Output a Fourier Transform of the histogram
"""
...
with xr.open_dataset(ds_path+ds_name) as ds:
    ...
    particle_histogram_ft_real = xr.DataArray(np.zeros([ds['image'].shape[0]]+histogram_shape),
                                coords=[ds['hologram_number']]+list(hist_bin_centers.values()),
                                dims=['hologram_number']+list(hist_bin_centers.keys()))
    particle_histogram_ft_imag = xr.DataArray(np.zeros([ds['image'].shape[0]]+histogram_shape),
                                coords=[ds['hologram_number']]+list(hist_bin_centers.values()),
                                dims=['hologram_number']+list(hist_bin_centers.keys()))
    ...
    ds_ft = ds_ft.assign(particle_histogram_ft_real=particle_histogram_ft_real) # add real part of histogram ft
    ds_ft = ds_ft.assign(particle_histogram_ft_imag=particle_histogram_ft_imag) # add imag part of histogram ft
