...
# the z axis
channel = xr.DataArray(['real','imag'],
                                dims=('channel'),
                                attrs={'description':'input channel'})

image_ft = xr.DataArray(np.zeros((ds0.dims['hologram_number'],
...
#                                         'units':'meters'})
channel_type = xr.DataArray(['real','imag'],
                                dims=('channel'),
