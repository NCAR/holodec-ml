...
settings={
        ...
        'n_filters':12, # number of input convolutional channels
        'nConv':5, # convolution kernel size
        'nPool':1, # max pool size
        'activation':'relu', # convolution activation
        'kernel_initializer':"he_normal",
        'latent_dim':32,
        'n_dense_layers':1, # number of dense layers in bottom layer
        ...
        'valid_fraction':0.2,
        'image_rescale':255.0,
        'beta':1e-2,   # KL divergence penalty scalar
