...
#         self.embedding = nn.Embedding(output_size, hidden_size)
#         #self.pe = PositionalEncoder(hidden_size, max_seq_len = 100)
...
#         for layer in [self.embedding, self.pe, self.gru, self.out]:
#             for p in layer.parameters():
#                 if p.dim() > 1:
#                     nn.init.xavier_uniform_(p)
                    
#         """
#             Add build method; move weight initialization into that
